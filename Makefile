...
DISTDIR = /home/i7620560/Documents/programming/specialist/obj/SDLOpenGL1.0.0
LINK          = clang++
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/base.hpp include/actor.hpp include/base.hpp include/object.hpp include/scene.hpp include/SDLOpenGL.hpp include/shader.hpp include/sim_time.hpp include/vectors.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp src/actor.cpp src/base.cpp src/object.cpp src/scene.cpp src/SDLOpenGL.cpp src/shader.cpp src/sim_time.cpp src/vectors.cpp $(DISTDIR)/
...
obj/main.o: main.cpp include/SDLOpenGL.hpp \
...
obj/SDLOpenGL.o: src/SDLOpenGL.cpp include/SDLOpenGL.hpp
