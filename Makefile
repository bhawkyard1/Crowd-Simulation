...
COMPRESS      = gzip -9f
DISTNAME      = CSIM1.0.0
DISTDIR = /home/i7620560/Documents/programming/specialist/crowds/Crowd-Simulation/obj/CSIM1.0.0
LINK          = clang++
...
obj/navPoint.o: src/navPoint.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/navPoint.o src/navPoint.cpp
